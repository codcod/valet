...
def upgrade() -> None:
    ...
    op.execute(
        "insert into users (name, surname, slack_id) values ('Nikos', 'Ka', 'U040RMTUD8E')"
    )
    ...
    op.bulk_insert(
        ...
        [
            ...
            {
                'timestamp': dt(2022, 12, 1, 10, 1, 0),
                'parking_day': d1,
                'user_id': 1,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 1, 10, 2, 0),
                'parking_day': d1,
                'user_id': 2,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 1, 10, 3, 0),
                'parking_day': d1,
                'user_id': 3,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 1, 10, 4, 0),
                'parking_day': d1,
                'user_id': 4,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 1, 10, 5, 0),
                'parking_day': d1,
                'user_id': 4,
                'status_id': 210,
            },
            {
                'timestamp': dt(2022, 12, 1, 10, 10, 1),
                'parking_day': d1,
                'user_id': 1,
                'status_id': 201,
            },
            ...
            {
                'timestamp': dt(2022, 12, 1, 10, 10, 2),
                'parking_day': d1,
                'user_id': 2,
                'status_id': 301,
            },
            ...
            {
                'timestamp': dt(2022, 12, 1, 10, 11, 1),
                'parking_day': d1,
                'user_id': 1,
                'status_id': 401,
            },
            {
                'timestamp': dt(2022, 12, 1, 10, 12, 1),
                'parking_day': d1,
                'user_id': 2,
                'status_id': 410,
            },
            ...
            {
                'timestamp': dt(2022, 12, 2, 11, 1, 0),
                'parking_day': d2,
                'user_id': 1,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 2, 11, 2, 0),
                'parking_day': d2,
                'user_id': 2,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 2, 11, 3, 0),
                'parking_day': d2,
                'user_id': 4,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 2, 11, 4, 0),
                'parking_day': d2,
                'user_id': 3,
                'status_id': 100,
            },
            {
                'timestamp': dt(2022, 12, 2, 11, 5, 0),
                'parking_day': d2,
                'user_id': 3,
                'status_id': 210,
            },
